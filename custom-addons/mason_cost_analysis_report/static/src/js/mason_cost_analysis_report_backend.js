odoo.define("mason_cost_analysis_report_backend", function(require) {
    "use strict";
    ...
    var report_backend = AbstractAction.extend({
        ...
        events: {
            "click .o_mason_cost_analysis_report_print": "print",
            "click .o_mason_cost_analysis_report_export": "export",
        },
    ...
    core.action_registry.add("mason_cost_analysis_report_backend", report_backend);
